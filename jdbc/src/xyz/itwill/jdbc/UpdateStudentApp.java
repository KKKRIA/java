...
//STUDENT 테이블에 저장된 학생정보 중 학번이 [2000]인 학생의 이름을 [임걱정]으로 변경하고 주소를 [부천시 원미구]로 변경하는JDBC 프로그램 작성 
public class UpdateStudentApp {
	public static void main(String[] args) {
		...
		try {
			//"oracle.jdbx.driver.OracleDriver" > 외우기 힘들면>
			//OracleDriver 임포트 불러와서 복사하기
