...
public class PreparedStatementApp {
	public static void main(String[] args) throws Exception {
		...
		//Connection.PreparedStatement(String sql) : Connection 객체로부터 SQL 명령이 저장된
		...
		String sql="insert into student values(?,?,?,?,?)";//분완전한 SQL 명령
		...
		//PreparedStatement.executeUpdate() : PreparedStatement 객체에 저장된 DML 명령을 전달하여 실행하고 조작형의 갯수를 정수값(int)로 반환하는 메소드
		...
		//PreparedStatement.Update(): PreparedStatement 객체에 저장된 SELECT 명령을 전달하여 실행하고 모든 검색행이 저장된 ResultSet객체를 반환하는 메소드
