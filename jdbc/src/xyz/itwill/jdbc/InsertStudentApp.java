...
public class InsertStudentApp {
	public static void main(String[] args) {
		...
		try {
			...
			// => OracleDriver 클래스를 읽어 메모리에 저장하여 
			...
			// => 동일한 클래스로 새성된 Driver 객체가 DriverManager 클래스에 여러개 등록 가능
			...
			//String sql="insert into student values(2000,'임꺽정','010-7894-5612','수원시 월정구','02/05/01')";
