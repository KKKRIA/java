...
// 단항연산자와 대입 연산자를 사용한 연산식은 오른쪽에서 왼쪽 방향으로 처리된다.
// ex ) A+B+C    a더하고 b더하고 c더하세요
// ex ) A=B=C    c를 b에 저장하고 a에 저장하세요
...
public class OperatorApp {
	public static void main(String[] args) {
		...
		System.out.println("20 > 10 = " + (20 > 10));
		System.out.println("20 < 10 = " + (20 < 10));  
		System.out.println("20 == 10 = " + (20 == 10)); //같다
		System.out.println("20 != 10 = " + (20 != 10)); //같지않다
		System.out.println("==============================================================");
		
		
		// 논리 연산자 : Bit 논리 연산자, 일반 논리 연산자
		// => Bit 논리 연산자 : 두 피연산자의 정수값을 Bit 단위로 계산하기 위한 연산자 - &(논리곱), ^(배타적 논리합), |(논리합)
		// => 일반 논리 연산자 : 두 개의 비교 연산식을 연결하기 위한 연산자 - &&(And), ||(Or)  같이있을 경우 엔드하고 오알계산
		// int c=20;
		int c = -20;
		...
		System.out.println("큰 값 = " + (d1 > d2 ? d1 : d2)); // d1과 d2를 비교해서 d1,d2중에 큰값을 노출
		System.out.println("==============================================================");
		// int d3=10;
		int d3 = 11;
