...
public class IfApp {
	public static void main(String[] args) {
		...
		int score = 90;
		// 변수값이 60이상인 경우 합격 메세지를 출력하고 60미만인 경우 불합격 메세지 출력되도록 프로그램 작성

		/*
		 * if(score>=60) { System.out.println("[결과]점수가 60점 이상이므로 <합격>입니다."); }
		 * 
		 * if(score<60) { System.out.println("[결과]점수가 60점 미만이므로 <불합격>입니다."); }
		 */
		...
		*/
		...
		// => X >= 작은값 && X <= 큰값 :X는 작은값부터 큰값사이의 범위안에 표현하는 값
