...
public class DoubleArrayApp {
	public static void main(String[] args) {
		...
		System.out.println("num[2][1]="+num[1][1]);
		System.out.println("num[2][2]="+num[1][2]);
		System.out.println("=============================================");
		...
		for(int i=0; i<num.length; i++) { //1차원 배열(행)을 일괄 처리하기위한 반복문
			for(int j=0; j<num[i].length; j++){//요소(열)를 일괄 처리하기위한 반복문
		...
		int[][] value=new int[3][];//3행 열없음 에러없음
		...
		//=>1차원 배열의 요소의 갯수를 다르게 생성하여 저장가능 - 가변배열
