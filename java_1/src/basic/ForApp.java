...
// => 반복의 횟수명확한 경우 사용하는 반복문(Loop Statement)
...
//   블럭 내부의 명령 실행  >> 증감식  >> 조건식(참) >> 블럭 내부의 명령 실행  >> 증감식  >> 조건식(참)

//=> 조건식의 결과가 거짓인 경우 반복문 종료
// 주의) 조건식의 결과가 계속 참인 경우 무한반복 - 무한루프(Endless Loop) >> 강제종료
// 초기식과 증감식은  , 기호를 사용하여 나열 작성 가능
// 초기식, 증감식은 생략이 가능 - 조건식이 생략된 경우 무조건 참으로 처리

public class ForApp {
	public static void main(String[] args) {
		//"Java Programming" 화면에 5번 출력
		...
		*/
		...
		for(; i<=4; i++){ //위에서 초기식을 사용했기때문에 생략했음 (;; 세미콜론은 무조건 2개가 들어가야함)
			System.out.print(i+"\t");
		}//i 변수애 5가 저장된 경우 반복문 종료
