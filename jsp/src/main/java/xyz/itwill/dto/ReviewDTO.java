...
public class ReviewDTO {
	...
	public ReviewDTO(int num, String id, String subject, String content, String regdate, int readcount, int ref,
			int restep, int relavel, String ip, int status) {
		super();
		this.num = num;
		this.id = id;
	...
	public int getRelavel() {
		return relavel;
	}


	public void setRelavel(int relavel) {
		this.relavel = relavel;
	}
