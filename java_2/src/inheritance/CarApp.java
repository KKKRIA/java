...
public class CarApp {
	public static void main(String[] args) {
		...
		*/
		...
		//Object클래스의  toString()클래스의 메소드가 아닌 Car클래스의 toString() 메소드 자동 호출
		System.out.println("car = "+car);
		System.out.println("====================================================");
	
		//문자열이 저장된 String 객체를 생성하여 객체의 메모리주소를 참조변수에 저장
		String name ="홍길동";
		//String 클래스에 오버라이드 선언된 toStrig()메소드 호출
		//=> String.toString() :  객체에 저장된 문자열을 반환하는 메소드
		//System.out.println("name =" +name.toString());
		
		//String 클래스의 참조변수를 출력할 경우 자동으로 String 클래스의 toStrig()메소드 호출
