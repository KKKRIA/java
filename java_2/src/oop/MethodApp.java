...
public class MethodApp {
	...
	public static void main(String[] args) {
		...
		//객체를 이용하여 메소드를 호출하면 프로그램의 흐름(스레드)은 
		//객체의 메소드로 이동하여 메소드의 명령을 실행하고 메소드가 종료되면 메소드를 호출한 
		//다음 차례의 명령을 실행
		method.displayOne(); 
		method.displayTwo(); 
		System.out.println("========================================");
		...
		method.printThree(19,88); //19부터 88까지
		method.printThree(67,12); //19부터 88까지
		System.out.println("========================================");
		...
		//배열의 메모리 주소를 반환하는 메소드를 호출하면 반환된 메모리주소를 참조변수에 저장
