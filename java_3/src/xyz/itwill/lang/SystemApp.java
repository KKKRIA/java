...
//Java.lang 패키지 : Java프로그램 개발에 필요한 기본 자료형을 제공하는 패키지
...
public class SystemApp {
	public static void main(String[] args) {
		//System.in : Java에서 제공되는 표준 입력장치(키보드)에 대한 입력스트림(객체)이 저장된 
		Scanner scanner=new Scanner(System.in);
		
		//System.out : Java에서 제공되는 표준 출력장치(모니터)에 대한 출력스트림(객체)이 저장된 
		...
		// => 1970년 1월 1일 기준으로 1초당 1/1000초(1ms)당 1씩 증가된 정수값
		// => 날짜와 시간을 정수값으로 표현하여 연산(-)하기 위해 사용
		long startTime=System.currentTimeMillis();
		
		for(int i=1;i<num;i++) {
			System.out.println(num+"번째 실행되는 명령");
		}
