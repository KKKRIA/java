...
// => String 객체는 저장된 문자열을 조작하기 위한 메소드 제공하지 않고 조작 결과를 반환하는 메소드 제공 - 문자열 간접처리
// => StringBuffer 객체에 저장된 문자열을 조작하기 위한 메소드를 제공 - 문자열 직접처리
...
public class StringBufferApp {
	public static void main(String[] args) {
		...
		//StringBuffer.toString() : StringBuffer객체에 저장된 문자열을 반환하는 메소드
		System.out.println("sb.toString()=" +sb.toString() );
		//StringBuffer객체가 저장된 참조변수를 출력할 경우 toString 메소드 자동 호출
		System.out.println("sb=" +sb);//ABC
		
		//StringBuffer객체에 저장된 문자열을 반환받아 String 객체로 생성하여 참조변수 저장
		String str=sb.toString(); //StringBuffer객체 >> String 객체
