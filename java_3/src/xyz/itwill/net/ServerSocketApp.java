	...
	public static void main(String[] args) {
		for(int i=2000;i<=9000;i+=1000) {
			try {
				...
				System.out.println("[메세지]"+i+"번 포트는 네트워크 프로그램에서 사용 불가합니다");
			}
		}
	}
}
