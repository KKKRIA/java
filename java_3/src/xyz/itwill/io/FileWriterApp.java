...
public class FileWriterApp {
	public static void main(String[] args) throws IOException {
		...
		//FileWriter out=new FileWriter("c:/data/char.txt"); //덮어쓰기
		FileWriter out=new FileWriter("c:/data/char.txt",true); //이어쓰기
