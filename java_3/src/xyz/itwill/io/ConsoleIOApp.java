...
//키보드로 이름과 태어난 태어난 년도를 입력받아 이름과 나이를 계산하여 출력하는 프로그램 작성
public class ConsoleIOApp {
	public static void main(String[] args) throws IOException {
		...
		//BufferedReader 클래스의 입력스트림으로 확장하여 대량의 문자데이타를 입력받을 수 있는 입력스트림 생성
		...
		//PrintStream 클래스로 생성되어 print() 또는 println() 메소드를 호출하여 매개변수로 전달받은 값을 문자열로 변환하여 출력스트림에 전달해 출력 가능
