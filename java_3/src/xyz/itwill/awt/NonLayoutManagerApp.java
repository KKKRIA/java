...
// => Frame, Window, Dialog 등 : BoderLayout
...
public class NonLayoutManagerApp extends Frame{
	...
	public NonLayoutManagerApp(String title) {
		...
		button1.setBounds(80,100,150,80); //출력위치x,출력위치y,버튼크기 가로,버튼크기 세로
		button2.setBounds(190,300,100,120); //출력위치x,출력위치y,버튼크기 가로,버튼크기 세로
