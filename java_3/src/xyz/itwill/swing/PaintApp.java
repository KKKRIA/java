...
public class PaintApp extends JFrame{
	...
	//마우스 버튼을 클릭한 위치의 자표값을 저장하기 위한 필드
	...
	public PaintApp(String title) {
		...
		public void mouseClicked(MouseEvent e) {
			//MouseEvent.getX() : 마우스를
			x=e.getX();
			y=e.getY();
			
			//Window.panint() 메소드를 수동으로 호출하는 메소드
			repaint();
		}
		});
	...
	//paint() 메소드 오버라이드 선언하여 컨테이너에 필요한 명령을 실행
	
	@Override
	public void paint(Graphics g) {
		//System.out.println("paint() 메소드가 호출");
