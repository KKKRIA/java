...
public class ExceptionThrowsApp {
	//예외가 발생된 명령의 메소드에서 예외처리를 하지 않고 발생된 예외를 메소드를 호출한 명령으로 전달 가능
	//명령으로 전달가능 - 예외 전달
	//형식)접근제한자 반환형 메소드명 (자료형 매개변수,...)throw 예외클래스, 예외클래스,...{}

	public static void display() throws ArrayIndexOutOfBoundsException{ //메소드를 호출한 명령한테 예외를 떠넘김
