...
public class StudentManagerApp {
	public static void main(String[] args) {
		...
		//저장매체에 저장된 모든 학생정보 중 학번이 2000인 학생의 이름을 임걱정으로 ★변경하는 메소드 호출
		...
		//저장매체에 저장된 모든 학생정보 중 학번이 [4000]인 학생정보를 ★삭제하는 메소드 호출
		...
		List<Student> studentList =manager.selectStudentList(); //전체학생을 반환받아서 일괄처리 메소드 호출
		
		for(Student student : studentList) {
			System.out.println(student); //toString 메소드 자동호출
		}
		System.out.println("======================================================================");
