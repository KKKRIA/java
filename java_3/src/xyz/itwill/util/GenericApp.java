...
public class GenericApp {
	public static void main(String[] args) {
		...
		generic2.setField(12.34);//오토언박싱 : 실수값 >> Double 객체
		
		Double returnObject2= generic2.getField();
		
		System.out.println("필드값 = "+returnObject2); //오토 언박싱 :  Double 객체 >> 실수값
		System.out.println("================================================================");
		
		
		
		/*
		//스트링은 넘버를 상속받지 않기 때문에 에러생김
