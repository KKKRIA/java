...
// => Object 타입의 필드에 저장된 객체를 반환받아 사용하기 위해서는 반드시 명시적 객체형변환을 해줘야한다
...
public class NonGenericApp {
	public static void main(String[] args) {
		...
		//필드값이 Object클래스의 객체로 반환되므로 반드시 명시적 형변환(Integer)을 사용해야 자식클래스의 참조변수에 객체를 저장 가능
		// => 자식클래스의 메소드 호출
		...
		nonGeneric2.setField(12.34);//오토박싱 : 실수값 >> Integer 객체
		...
		System.out.println("필드값= "+returnObject3); //오토언박싱 : Double 객체 >> 실수값
		System.out.println("==============================================================");
	}
}
