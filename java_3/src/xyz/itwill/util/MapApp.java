...
//Map인터페이스를 상속받은 콜렉션 클래스 - ★HachMap, Hashtable, ★Properties 등
...
public class MapApp {
	public static void main(String[] args) {
		...
		//Map.put(K ket, V valus) : Map 객체에 엔트리를 추가하는 메소드
		// => Map 객체에 저장되는 엔트리의 이름(key)을 Set 객체로 저장됨므로 중복 저장 불가능
		//내가 원하는 값을 빠르게 찾기 위해 key 사용 , 중복되면 안됨
		map.put("1000", "홍길동");
		map.put("2000", "임꺽정");
		map.put("3000", "전우치");
		map.put("4000", "일지매");
		...
		//검색속도를 빠르게 하려고 key 사용 , 순서 중요하지 않음
		
		System.out.println("===================================================================");
		
		
		//★Map.put(K key, V value) : 메소드 호출시 이름이 중복된 경우 해당 이름(key)의 엔트리의 객체(Value)를 ★변경하여 저장
		map.put("2000", "임걱정");
		System.out.println("map=" +map);
		System.out.println("===================================================================");
		...
		// => 이름(key)에 대한 엔트리가 없는 경우 null을 반환 
